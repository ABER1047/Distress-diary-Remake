...
for(var i = 0; i < image_xscale*4+rd_val; i++)
{
	...
	effect_ins_arr[effect_ins_arr_ind] = create_bubble_effect(tmp_xx,tmp_yy,-1,#3B3447,#222034,0,-irandom_range(8,16),irandom_range(-10,10),0.02,0,false,-tmp_yy,20+irandom_range(0,20));
