...
if (show_interaction_key > 0)
{
	...
	{
		draw_circular_bar(tmp_key_xx,tmp_key_yy-32*txt_scale/global.h_ratio_by_window,global.interaction_hold_time,global.interaction_hold_time_max,c_white,72*txt_scale,1,24*txt_scale,-4);
	}
