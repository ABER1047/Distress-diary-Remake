...
if (chat_alpha > 0)
{
	...
	{
		draw_text_kl_scale(tmp_text_xx,yy+yy_h-c_x*64,string(chat_entering)+"|",64,9999,chat_alpha,c_white,0,-1,font_normal,0.3,0.3,0,true);
	}
	...
	draw_text_kl_scale(tmp_text_xx,yy+yy_h-c_x*280,tmp_chat_to_draw,64,9999,chat_alpha,c_white,0,-1,font_normal,0.3,0.3,0,true);
