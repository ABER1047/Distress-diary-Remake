...
if (draw_alpha > 0)
{
	var tmp_yy = y-(86*global.ratio_by_camera+z);
	if (show_interaction_key > 0)
	{
		...
		{
			draw_circular_bar(tmp_key_xx,tmp_key_yy-32*global.ratio_by_camera,global.interaction_hold_time,global.interaction_hold_time_max,c_white,72*global.ratio_by_camera,1,24*global.ratio_by_camera,#17111A);
		}
	...
	{
		draw_text_k_scale(x,tmp_yy,string(nickname),64,-1,1,c_white,0,0,font_normal,0.3,0.3,0);
