...
global.attack_damage_origin = 3; //공격력
...
global.bleeding_chance = 0; //출혈 찬스
global.poisoning_chance = 0; //독 찬스
global.burning_chance = 0; //화염 찬스
global.mana_decreasement = 0; //감소 마나량
global.charging_split = 1; //차징 단계 분리 정도
global.luck = 0;
...
global.attack_type = 0; //0 - 수동 공격 / 1 - 자동 공격 / 2 - 차징 후 차징 게이지 만큼 자동 공격 / 3 - 풀차징시 데미지 3배 / 4 - 차징 후 투사체 발사
